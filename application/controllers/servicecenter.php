 ...
 * 
 * FileName application/controllers/servicecenter.php
 * Created by CIscaffolding.
 * User: qujiakang
 * QQ:myqq_postor@qq.com
 * Email: qujiakang@gmail.com  
 * Date: Wed Feb 06 12:54:56 CST 2013
 *    
 */

class Servicecenter extends Media_Controller {
     
    public  function __construct(){
        parent::__construct("Servicecenter_model");
    ...
    public function index(){
        ...
        $this->load->view("servicecenter/index",$data);
