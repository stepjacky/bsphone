<link href="/resources/styles/join.css" rel="stylesheet" type="text/css" media="screen"/>

<div class="total">
    <!--
    <div class="place">
                    <span class="site">您当前的位置：<a class="gray" title="首页" href="http://www.22shop.com">首页</a>
                        » <a class="gray" title="加盟飞鸿" href="/join.html">加盟飞鸿</a> » 加盟费用</span>
    </div>
    -->
    <div class="matter">
        <div class="advert">
            <img class="join-title-img" title="加盟BE数码通讯，共创未来，共创未来" alt="加盟BE数码通讯，共创未来"
                 src="/resources/images/index/join_03.jpg">
        </div>
            ...
            <div class="join_nav">
                <ul id="nav">
                    ...
                    <li class=""
                        ...
                        <a title="加盟优势"
                                                                                 href="/joinus/index/advantage">加盟优势</a>
                        <a
                            title="增值意义" href="/joinus/index/desc">增值意义</a>
                        <a title="统一制胜"
                                                                                href="/joinus/index/winning">统一制胜</a>
                    </span>
                    </li>
                    <li class="join_line">|</li>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    $("ul#nav li").hover(function () { //Hover over event on list item
                        $(this).find("span").show(200).css({ 'background':'#ffffff', 'border':'1px solid #d7d7d7', 'display':'block' }); //Show the subnav
