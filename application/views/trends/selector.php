<div style="margin-bottom: 18px;" class="tabbable">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a data-toggle="tab" href="javascript:;" onclick="loadAll()">全部动态</a></li>
        <li><a data-toggle="tab" href="javascript:;">查询动态</a></li>
...
<script type="text/javascript">
    ...
    var selected = [];
    function loadAll(){
        var url='/trends/list_with_paged';
        $("#phones").load(url);
    }
