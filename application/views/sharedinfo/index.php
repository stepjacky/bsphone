                ...
                <div class="use_div">
                    ...
                    <div class="share_text">
                        <div class="selectdiv">
                            ...
                            <strong>购买了</strong>
                            <select id="sbrand"></select>
                            <select id="sphone"></select>

                        </div>
                        <div class="xd">
                            <div class="xd_txt">
                                <p><img src="/resources/images/index/merit.gif" alt=""></p>
                                <p><span><textarea id="use_cont" name="use_cont" ></textarea></span></p>
                            </div>
                            <div class="xd_txt">
                                <p><img src="/resources/images/index/fault.gif" alt=""></p>
                      ...
                      <label><input type="checkbox" id="turn_send" name="turn_send" value="1"><img src="/resources/images/index/sina.gif" alt=""></label>
                            ...
                            <small><input type="button" value="" name="submit" id="usepost_button" onclick="add_sharedinfo();"></small>
                        </div>
                    </div>
...
<script type="text/javascript" src="/resources/scripts/sharedinfo/index.js"></script>
