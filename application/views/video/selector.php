<div style="margin-bottom: 18px;" class="tabbable">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a data-toggle="tab" href="javascript:;" onclick="loadAll()">全部视频</a></li>
        <li><a data-toggle="tab" href="javascript:;">查询视频</a></li>
