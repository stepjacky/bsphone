...
$(function(){
   ...
   $("#branch_name").bind("change",branchChange);
    ...
    $.get('/brand/options',function(beans){
       $("#sbrand").html(beans);
    });
   ...
   $('#sbrand').bind('change',brandChange);
...
function brandChange(){
    ...
    $.get('/phone/options/'+brand,function(opts){
        $("#sphone").html(opts);
...
function add_sharedinfo(){
    ...
    var sphone = $("#sphone").find("option:selected");
    var id = sphone.val();
    var name = sphone.text();
